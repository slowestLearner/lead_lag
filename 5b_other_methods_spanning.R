# -- Show that spanning tests don't work
source("runmefirst.R")
library(this.path)
...
for (stock_base in c("all", "large")){
  file_path <- file.path("tmp/portfolio_results", stock_base, "scale_by_total/remove_20pct_stk_FALSE/")
  ...
  # wait wait what is going on with geo?
